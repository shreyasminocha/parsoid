...
class WikitextConstants {
	...
	public static function init() {
		...
		self::$HTMLTagsWithWTEquivalents = makeSet([
			"a", "b", "p", "pre",
			"hr", "i", "img", "link", "meta",
			"h1", "h2", "h3", "h4", "h5", "h6",
			"ol", "li", "ul", "dd", "dl", "dt",
		...
		self::$HTMLTagsRequiringSOLContext = makeSet([
			"pre",
			"h1", "h2", "h3", "h4", "h5", "h6",
			"ol", "li", "ul", "dd", "dl", "dt",
		]);
		...
		self::$WeakIndentPreSuppressingTags = makeSet([
			'table', 'tbody', 'tr',
		]);
		...
		*/
		self::$StrongIndentPreSuppressingTags = makeSet([
			'blockquote', 'pre', 'p',
			'h1', 'h2', 'h3', 'h4', 'h5', 'h6',
			'ul', 'ol', 'dl', 'li',
		]);
		...
		self::$SolSpaceSensitiveTags = makeSet([
			'h1', 'h2', 'h3', 'h4', 'h5', 'h6',
			'ul', 'ol', 'li', 'dl', 'dd', 'dt',
		]);
		...
		self::$BlockScopeOpenTags = makeSet([
			'blockquote', 'pre', 'p',
			'h1', 'h2', 'h3', 'h4', 'h5', 'h6',
			'ul', 'ol', 'li', 'dl',
			'table', 'tr',
		...
		# See doBlockLevels in the PHP parser (includes/parser/Parser.php)
		self::$BlockScopeCloseTags = makeSet([
			'td', 'th',
		]);
		...
		self::$HTML = array(
			...
			'FormattingTags' => makeSet([
				'a', 'b', 'big', 'code', 'em', 'font', 'i', 'nobr',
				's', 'small', 'strike', 'strong', 'tt', 'u',
			]),

			'ListTags' => makeSet(['ul', 'ol', 'dl']),

			'ListItemTags' => makeSet(['li', 'dd', 'dt']),

			'FosterablePosition' => makeSet(['table', 'tbody', 'tr']),
			...
			'ParentTableTags' => makeSet([
				"table", "tbody", "thead", "tfoot", "tr",
			]),

			# Table tags that can be children
			'ChildTableTags' => makeSet([
